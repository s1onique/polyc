...
static input_t INPUTS[] = {
    /* Category A: numeric extent/value (41 cases) */
    {"dec_0",        "0;",       0, 0},
    {"dec_1",        "1;",       0, 0},
    {"dec_9",        "9;",       0, 0},
    {"dec_10",       "10;",      0, 0},
    ...
    {"dec_007_leading_zero", "007;", 0, 0},
    {"dec_000", "000;", 0, 0},
    {"dec_1_at_cursor1", "x1;", 1, 0},
    {"dec_2pow31", "2147483648;", 0, 0},
    {"dec_max_u64", "18446744073709551615;", 0, 0},
    {"dec_overflow_u64", "99999999999999999999;", 0, 0},
    {"hex_0x0",       "0x0;",   0, 0},
    {"hex_0x1",       "0x1;",   0, 0},
    {"hex_0x7f",      "0x7f;",  0, 0},
    {"hex_0XFF",      "0XFF;",  0, 0},
    ...
    {"hex_0XDEADBEEF","0XDEADBEEF;", 0, 0},
    {"hex_0xCAFEBABE","0xCAFEBABE;", 0, 0},
    {"hex_0xMixedCase","0xAbCdEf;", 0, 0},
    {"hex_0xff_no_semi", "0xff\n", 0, 0},
    {"hex_0x_op_letter", "0xZ;", 0, 0},
    {"flt_0_0",    "0.0;",   0, 0},
    {"flt_1_0",    "1.0;",   0, 0},
    {"flt_1_",     "1.;",    0, 0},
    {"flt_123_456","123.456;", 0, 0},
    {"flt_1_0f32", "1.0f32;", 0, 0},
    {"flt_1_0f64", "1.0f64;", 0, 0},
    {"exp_1e2_i64",  "1e2;",    0, 0},
    {"exp_1e_neg",   "1e-2;",   0, 0},
    {"exp_1e_plus",  "1e+2;",   0, 0},
    {"exp_2_5e10",   "2.5e10;", 0, 0},
    {"exp_3_14e_neg","3.14e-5;",0, 0},
    {"err_hex_with_dot", "0x.5;", 0, 0},
    {"err_hex_with_e",   "0xFe;", 0, 0},
    {"err_two_dots",     "1.2.3;", 0, 0},
    {"err_two_e_letters","1e2e3;", 0, 0},
    {"err_two_x_letters","0xx1;", 0, 0},
    {"nz_xx123",   "xx123;",  2, 0},
    {"nz_xx0xff",  "xx0xff;", 2, 0},
    {"nz_xx1_5",   "xx1.5;",  2, 0},
    {"nz_xx_a_",   "xx'a';",  2, 0},

    /* Category B: char constants (28 cases) */
    {"chr_a",     "'a';",    0, 0},
    {"chr_0",     "'0';",    0, 0},
    {"chr_sp",    "' ';",    0, 0},
    {"chr_tilde", "'~';",    0, 0},
    ...
    {"chr_ab",    "'ab';",   0, 0},
    {"chr_abc",   "'abc';",  0, 0},
    {"chr_8slots","'abcdefgh';", 0, 0},
    {"chr_a_nl_b","'a\\nb';",0, 0},
    {"chr_dq_escaped","'\\\"x';",0,0},
    {"chr_sq_escaped","'\\'x';",0,0},
    {"chr_no_semi","'a'",    0, 0},
    {"chr_with_semi_space","'a' ",0, 0},
    {"chr_overflow", "'abcdefghij';", 0, 0},
    {"chr_8slots_overflow", "'abcdefghi';", 0, 0},
    {"chr_unterm",   "'abc",   0, 0},
    {"chr_unterm_at_eof", "'a", 0, 0},

    /* Category C: error/negative controls (16 cases) */
    {"err_hex_with_dot2", "0x.5;", 0, 0},
    {"err_hex_with_e2",   "0xFe;", 0, 0},
    {"err_two_x_letters2","0xx1;", 0, 0},
    {"err_two_dots2",     "1.2.3;", 0, 0},
    {"err_trailing_dot",  "1.;", 0, 0},
    {"err_lone_dot",      ".", 0, 0},
    {"err_two_e_letters2","1e2e3;", 0, 0},
    {"err_e_no_digits",   "1e", 0, 0},
    {"err_e_trailing_minus", "1e-", 0, 0},
    {"err_char_unterm",   "'abc", 0, 0},
    {"err_char_overflow", "'abcdefghij';", 0, 0},
    {"err_char_8slots_overflow", "'abcdefghi';", 0, 0},
    {"err_char_unterm_eof", "'a", 0, 0},
    {"err_cur_on_letter", "abc;", 0, 0},
    {"err_cur_on_op",     "+abc;", 0, 0},
    {"err_cur_at_eof",    "42", 2, 0},

    /* Category D: nonzero cursor / cursor edge (3 cases) */
    {"cur_past_end",  "1;",     5, 0},
    {"cur_negative",  "1;",    -1, 0},
    {"cur_at_boundary","1;",    1, 0},
};
