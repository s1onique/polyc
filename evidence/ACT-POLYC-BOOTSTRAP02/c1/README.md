...
-----
  ...
  identifier-contract.txt            AC02, AC03: grammar freeze + equivalence
  legacy-ident-oracle.tsv            AC04: legacy identifier-span oracle
  ...
  c1-required-result.txt             binding result block
